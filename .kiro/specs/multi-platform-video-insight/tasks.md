...
- [x] 8. 视频处理流水线（下载→转录→清洗→分段）
  ...
  - [ ]* 8.6 为 TranscriptCleaner 编写属性测试
...
- [x] 11. 异步流水线调度
  ...
  - [ ]* 11.2 为 AsyncPipelineManager 编写单元测试
    - 测试 Mode1 串行处理顺序
    - 测试 Mode2 并发数限制（信号量）
    - 测试缓存命中时跳过处理
    - _需求: 17.1, 17.2, 17.4_
